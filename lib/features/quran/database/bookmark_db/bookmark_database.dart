...
import 'package:alslat_aalnabi/features/quran/presentation/screens/quran_page/data/model/bookmark.dart';
import 'package:alslat_aalnabi/features/quran/presentation/screens/quran_page/data/model/bookmark_ayahs.dart';

part 'bookmark_database.g.dart';

@DriftDatabase(tables: [Bookmarks, BookmarksAyahs])
class BookmarkDatabase extends _$BookmarkDatabase {
  ...
  Future<int> updateBookmarkAyah(
    ...
    bookmarksAyahs,
  )..where((tbl) => tbl.id.equals(id))).write(bookmarkAyah);
