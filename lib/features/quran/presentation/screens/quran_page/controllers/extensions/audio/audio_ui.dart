...
extension AudioUi on AudioController {
  ...
  void playAyahOnTap(
    ...
    log(
      's: ${quranCtrl.state.surahs[state.currentSurahNumInPage.value - 1].arabicName} | state.currentAyahUQInPage: ${state.currentAyahUQInPage.value}',
  ...
  Future<void> changeReadersOnTap(int index) async {
    ...
    // Get.back(); // Removed as PopupMenuButton handles its own dismissal and this might pop the page incorrectly
    state.isPlay.value
