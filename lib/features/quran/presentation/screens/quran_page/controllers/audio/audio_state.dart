...
class AudioState {
  ...
  Uri cachedArtUri = Uri.parse('about:blank');
  late var cancelToken = CancelToken();
  final Completer<void> initCompleter =
      Completer<void>(); // Added for robust initialization
  ...
  StreamSubscription<int?>? playerIndexSubscription;
  StreamSubscription<Duration>? playerPositionSubscription;
}
